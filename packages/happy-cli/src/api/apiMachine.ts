...
export class ApiMachineClient {
    ...
    setRPCHandlers({
        ...
        this.rpcHandlerManager.registerHandler('spawn-happy-session', async (params: any) => {
            ...
            const result = await spawnSession({ directory, sessionId, resumeSessionId, intent, sessionTitle, skipForkSession, machineId, approvedNewDirectoryCreation, agent, token, environmentVariables, worktreeBasePath, worktreeBranchName, workspaceRepos, workspacePath, repoScripts, mcpServers });
