...
export class CodexPermissionHandler extends BasePermissionHandler {
    ...
    private shouldAutoApprove(toolName: string, toolCallId: string): boolean {
        const alwaysAutoApproveNames = ['change_title', 'happy__change_title', 'preview_html', 'happy__preview_html', 'list_bugs', 'happy__list_bugs', 'get_bug', 'happy__get_bug', 'CodexReasoning', 'think', 'save_memory'];
