...
- Bug feedback: improve the shared desktop board with balanced two-column layout, compact detail headers and bug cards, no duplicate left-card actions, horizontal status filters, and cleaner status history.
