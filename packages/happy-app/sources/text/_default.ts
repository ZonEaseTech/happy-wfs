...
export const en = {
    ...
    openclaw: {
        ...
        machineTypeHappy: 'Happy AI Machine',
        machineTypeHappyDescription: 'Connect through a Happy AI machine on your computer',
        ...
        noSessionsDescription: 'Start a new session to chat with AI',
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Happy AI is a Claude Code, Codex, and Gemini mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic or OpenAI.',
        whatsNew: 'What\'s New',
    ...
    session: {
        ...
        abortConfirmMessage: 'Are you sure you want to abort the current session?',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: 'Share session?',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `Share this session with ${names} so they can send messages?`,
            mentionShareConfirmAction: 'Share and send',
            mentionShareFailed: 'Failed to share session before sending.',
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Happy AI Server',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Please run npm install -g @zonease/happy@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Install the Happy AI CLI',
            runIt: 'Run it',
    ...
    fileViewer: {
        ...
        download: 'Download',
        deleteFile: 'Delete file',
        deleteFileConfirm: ({ name }: { name: string }) => `Delete "${name}"? This is irreversible.`,
        deleteDir: 'Delete folder',
        deleteDirConfirm: ({ name }: { name: string }) => `Delete folder "${name}" and all its contents? This is irreversible.`,
    ...
    settingsVoice: {
        ...
        happyVoiceDescription: 'Configure your self-hosted Happy AI Voice gateway.',
        gatewayUrl: 'Gateway URL',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Happy AI account. This will allow the terminal to send and receive messages securely.',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `happy daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g @zonease/happy@latest`',
        daemon: 'Daemon',
        status: 'Status',
    ...
    bug: {
        ...
        noteStyleSubtitle: 'Write like Notes: text, screenshot, then more text. A compact title is generated automatically.',
        noteStylePlaceholder: 'Describe the issue:\nsteps, expected result, actual result.\n\nPaste a screenshot where the cursor is.',
