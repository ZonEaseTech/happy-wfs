...
export const it: TranslationStructure = {
    ...
    devices: {
        ...
        emptyDescription: 'Generate an enrollment command and run it once on a server or computer.',
        enrollTitle: 'Enrollment command',
        enrollHint: 'Run this on the target machine (valid for 15 minutes, single use):',
        needLogin: 'Sign in first to generate an enrollment command',
    },
    ...
    settings: {
        ...
        devicesSubtitle: 'Enroll servers and computers for AI to work on',
        history: 'History',
    ...
    memory: {
        ...
        tabAll: 'Tutte',
        tabEmpty: 'Ancora niente in questa scheda',
    },
    ...
    wizard: {
        ...
        installCursor: 'Installa la CLI cursor-agent se disponibile',
        viewCursorDocs: 'Vedi la documentazione di Cursor →',
        add: 'Add',
        duplicate: 'Duplicate',
        delete: 'Delete',
