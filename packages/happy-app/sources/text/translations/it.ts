...
export const it: TranslationStructure = {
    ...
    openclaw: {
        ...
        machineTypeHappy: 'Macchina Happy AI',
        machineTypeHappyDescription: 'Connetti tramite una macchina Happy AI sul tuo computer',
    ...
    portProxy: {
        emptyTitle: 'No Port Proxies',
        emptyDescription: 'Expose a local HTTP service through Happy Server relay',
        addProxy: 'Add Proxy',
        editProxy: 'Edit Proxy',
        listTitle: 'Port Proxies',
        name: 'Name',
        namePlaceholder: 'Local web app',
        selectMachine: 'Select Machine',
        noMachines: 'No machines available',
        noMachinesDescription: 'Connect a Happy machine before creating a proxy',
        localHost: 'Local Host',
        localPort: 'Local Port',
        localPortHint: 'Only loopback HTTP targets are supported in this version.',
        options: 'Options',
        enabled: 'Enabled',
        disabled: 'Disabled',
        enabledDescription: 'Allow authenticated relay requests to reach this local service',
        create: 'Create Proxy',
        privateOnlyHint: 'Relay links are private and require your Happy account authentication.',
        deleteTitle: 'Delete Proxy',
        deleteMessage: ({ name }: { name: string }) => `Delete "${name}"?`,
        loadFailed: 'Failed to load port proxies',
        ...
        relayUrl: 'Relay URL',
        copyRelayUrl: 'Tap to copy the relay URL',
        machineLockedHint: 'Changing machines is not supported while editing. Create a new proxy to use another machine.',
    },
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Happy AI è un client mobile per Claude Code, Codex e Gemini. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic o OpenAI.',
        whatsNew: 'Novità',
        ...
        portProxySubtitle: 'Relay local ports through Happy Server',
        history: 'History',
    ...
    settingsFeatures: {
        ...
        inputFeaturesDescription: 'Manage Enter-to-send separately for desktop web and mobile apps.',
        enterToSendWeb: 'Web/Desktop Enter to Send',
        enterToSendWebEnabled: 'Web/Desktop: Enter sends (Shift+Enter for a new line)',
        enterToSendWebDisabled: 'Web/Desktop: Enter inserts a new line',
        enterToSendMobile: 'Mobile Enter to Send',
        enterToSendMobileEnabled: 'Mobile: Return sends',
        enterToSendMobileDisabled: 'Mobile: Return inserts a new line',
    ...
    settingsFeishu: {
        ...
        footer: 'When a session ends, the server posts a metadata-only message to your Feishu group bot. Content is end-to-end encrypted and never sent.',
        mentionWebhookSection: 'Collaboration @ webhook',
        mentionFooter: 'When a collaboration note mentions someone, the server sends one message to this webhook. The note text is sent externally and truncated to 500 characters.',
        mentionEnableTitle: 'Enable collaboration @ notifications',
        mentionEnableSubtitle: 'Only collaboration notes with @ mentions use this webhook',
        mentionTestTitle: 'Send a collaboration @ test',
        mentionTestSubtitle: 'Verify the @ webhook independently',
        mentionTestSubtitleWithTime: ({ time }: { time: string }) => `Last @ test: ${time}`,
        mentionTestSuccessMessage: 'Check your Feishu group for the collaboration @ test message.',
        userIdLabel: 'My Feishu user ID (optional)',
        userIdPlaceholder: 'ou_xxx or employee user_id',
        userIdHint: 'When set, collaboration @ notifications ping you with a real Feishu @ mention. You must be in the bot group. Find the ID in the Feishu admin console.',
        urlLabel: 'Webhook URL',
        secretLabel: 'Signing secret (optional)',
        secretPlaceholder: 'Leave empty to keep current',
        secretHint: 'Required when the bot has signature verification enabled.',
        enableTitle: 'Enable Feishu notifications',
        enableSubtitle: 'Master switch — turn off to silence without losing config',
        saveTitle: 'Save changes',
        saveDirty: 'You have unsaved changes',
        saveClean: 'No pending changes',
        testTitle: 'Send a test message',
        testSubtitle: 'Verify the webhook before saving',
        testSubtitleWithTime: ({ time }: { time: string }) => `Last tested: ${time}`,
        testSuccessTitle: 'Test sent',
        testSuccessMessage: 'Check your Feishu group for the test message.',
    ...
    session: {
        tabs: {
            active: 'In corso',
            closure: 'Da archiviare',
            inactive: 'Archiviate',
        },
        inputPlaceholder: 'Scrivi un messaggio ...',
        abortConfirmTitle: 'Interrompere sessione?',
        abortConfirmMessage: 'Sei sicuro di voler interrompere la sessione corrente?',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: 'Condividere la sessione?',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `Condividere questa sessione con ${names} così possono inviare messaggi?`,
            mentionShareConfirmAction: 'Condividi e invia',
            mentionShareFailed: 'Impossibile condividere la sessione prima dell\'invio.',
            ...
            allowPublicChat: 'Allow chat',
            allowPublicChatDescription: 'Let anyone with the link send messages to this session.',
            publicChatPlaceholder: 'Type a message...',
            publicChatSendFailed: 'Failed to send message',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un Happy AI Server valido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sessione Happy AI copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Happy AI',
        happySessionId: 'ID sessione Happy AI',
        ...
        autoReviewGuardUncertain: 'Review uncertain',
        autoReviewGuardSettings: 'Auto Review Guard Settings',
        autoReviewGuardRunNow: 'Review now',
        autoReviewGuardRunNowStarted: 'Auto review triggered',
        autoReviewGuardRunNowFailed: 'Failed to trigger auto review',
        autoReviewGuardEnabledLabel: 'Enable guard for this session',
        autoReviewGuardEnabledHint: 'Listen for completion claims and review code completion automatically.',
        autoReviewGuardDelay: 'Trigger delay (seconds)',
        autoReviewGuardTriggers: 'Trigger phrases, one per line',
        autoReviewGuardTriggersPlaceholder: '已完成\\n验证通过\\nplease confirm',
        autoReviewGuardSimplifyOnPass: 'Send /simplify after review passes',
        autoReviewGuardSimplifyOnPassHint: 'Use /simplify only as the final cleanup step after a passed review.',
        autoReviewGuardReviewPrompt: 'Reviewer prompt',
        autoReviewGuardFollowUpTemplate: 'Follow-up template',
        autoReviewGuardTemplateHint: 'Available variables: {{missing}}, {{summary}}, {{evidence}}',
        autoReviewGuardRestoreDefaults: 'Restore defaults',
        autoReviewGuardSaveDefault: 'Save as default',
        autoReviewGuardSaveSession: 'Save session',
        autoReviewGuardSavedSession: 'Auto review session settings saved',
        autoReviewGuardSavedDefault: 'Auto review default settings saved',
        ...
        updateCliInstructions: 'Esegui npm install -g @zonease/happy@latest',
        ...
        mentions: {
            partialFailureTitle: 'Some mentions failed',
            partialFailureMessage: ({ names }: { names: string }) => `Could not notify ${names}`,
            mentionNotifyTitle: 'You were mentioned',
            mentionNotifyMessage: ({ names }: { names: string }) => `${names} mentioned you in a session`,
            mentionNotifyAction: 'Open session',
        },
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI Happy AI',
            runIt: 'Avviala',
    ...
    sidebar: {
        ...
        closure: {
            mark: 'Segna per archiviare',
            unmark: 'Rimuovi marca archiviazione',
        },
    },
    ...
    files: {
        ...
        foundNearbyRepos: 'Trovati questi repository git nelle sottocartelle (tocca per passare)',
    ...
    fileViewer: {
        ...
        saveFailed: 'Impossibile salvare il file.',
        binaryNotSupported: 'Impossibile aprire un file binario.',
        unsavedChangesTitle: 'Modifiche non salvate',
        unsavedChangesSingle: ({ name }: { name: string }) => `«${name}» ha modifiche non salvate. Salvare prima di chiudere?`,
        unsavedChangesMulti: ({ count }: { count: number }) => `${count} file hanno modifiche non salvate. Salvarli tutti prima di chiudere?`,
        noFileOpen: 'Nessun file aperto',
        cursorPosition: ({ line, column }: { line: number; column: number }) => `Rig. ${line}, col. ${column}`,
        cursorPositionUnknown: 'Rig. —, col. —',
        encodingUtf8: 'UTF-8',
        languageLabel: ({ language }: { language: string }) => `Lingua: ${language}`,
        saveAll: 'Salva tutto',
        refresh: 'Aggiorna',
        find: 'Trova',
        replace: 'Sostituisci',
        gotoLine: 'Vai alla riga',
        upOneLevel: 'Livello superiore',
        ...
        download: 'Scarica',
        deleteFile: 'Elimina file',
        deleteFileConfirm: ({ name }: { name: string }) => `Eliminare «${name}»? Questa operazione è irreversibile.`,
        deleteDir: 'Elimina cartella',
        deleteDirConfirm: ({ name }: { name: string }) => `Eliminare la cartella «${name}» e tutto il suo contenuto? Questa operazione è irreversibile.`,
        renamePrompt: 'Nuovo nome',
        newFilePrompt: 'Nome file',
        newFolderPrompt: 'Nome cartella',
        fileExists: 'Esiste già un file con questo nome.',
        dirExists: 'Esiste già una cartella con questo nome.',
        upload: 'Carica',
        uploading: 'Caricamento...',
        uploadFailed: 'Caricamento non riuscito',
        uploadOverwriteConfirm: ({ name }: { name: string }) => `"${name}" esiste già. Sovrascrivere?`,
        diff: 'Diff',
        diffLoading: 'Caricamento diff…',
        diffUnavailable: 'Diff non disponibile (HEAD non raggiungibile)',
    },
    ...
    claudeConfig: {
        ...
        agentsMdSubtitle: 'Istruzioni a livello utente per strumenti compatibili con AGENTS.md (codex, ecc.)',
    ...
    injectedMemories: {
        ...
        manageAll: 'Gestisci tutte le memorie',
    },
    ...
    settingsVoice: {
        ...
        providerDescription: 'Scegli quale servizio vocale utilizzare. Le modifiche hanno effetto dalla prossima sessione vocale.',
        providerElevenLabsSubtitle: 'Servizio vocale IA ElevenLabs',
        providerHappyVoiceSubtitle: 'Servizio vocale IA profondamente ottimizzato',

        elevenLabsTitle: 'ElevenLabs',
        elevenLabsDescription: 'Configura il tuo agente ElevenLabs. Lascia vuoto per usare il predefinito.',
        agentId: 'ID agente',
        agentIdPlaceholder: 'Inserisci l\'ID agente ElevenLabs',

        happyVoiceTitle: 'Happy AI Voice',
        happyVoiceDescription: 'Configura il tuo gateway vocale Happy AI Voice self-hosted.',
        gatewayUrl: 'URL del gateway',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Happy AI. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
        ...
        noBackgroundTerminals: 'No background terminals.',
        closeTerminalWorkspace: 'Close this terminal group',
        terminalCount: ({ count }: { count: number }) => `${count} terminal${count === 1 ? '' : 's'}`,
        quickCommands: 'Quick commands',
        quickCommandsAddTitle: 'Add quick command',
        quickCommandsEditTitle: 'Edit quick command',
        quickCommandsEditAction: 'Edit',
        quickCommandsNamePrompt: 'Enter a display name for this command.',
        quickCommandsNamePlaceholder: 'Command name',
        quickCommandsCommandPrompt: 'Enter the terminal command to run.',
    ...
    repoEdit: {
        ...
        copyFilesFooter: 'File separati da virgola copiati nel worktree (es. .env,.env.local). I percorsi assoluti vengono copiati nella radice del workspace (es. /workspace/.mcp.json).',
    ...
    feed: {
        ...
        sessionMentionFallback: 'Someone mentioned you in a session',
    },
    ...
    wizard: {
        ...
        showMoreProfiles: ({ count }: { count: number }) => `Mostra altri (${count})`,
    ...
    bug: {
        ...
        createSubtitle: 'Write the issue once; screenshots can be pasted, dragged, or uploaded in the same area.',
        createPlaceholderDetailed: 'Describe what happened, expected result, and actual result. You can paste screenshots here with Ctrl/Cmd + V.',
        noteStyleSubtitle: 'Write it like Notes: text, screenshot, then more text. A compact title is generated automatically.',
        noteStylePlaceholder: 'Describe the issue:\nsteps, expected result, and actual result.\n\nPaste a screenshot and it will be inserted at the cursor.',
        noteStyleContinuePlaceholder: 'Keep typing, or paste the next screenshot...',
        noteStyleFooterHint: 'Paste, drag, or click to add images. Problem description is required.',
        previewTitlePlaceholder: 'Waiting for problem description',
        imageCounter: ({ count, max }: { count: number; max: number }) => `${count}/${max} screenshots`,
        imageDropTitle: 'Screenshots are part of the problem content',
        imageDropHint: 'Paste, drag, or click to upload. Up to 10 images, 20MB each.',
        pasteShortcut: 'Ctrl/Cmd + V',
        clickToUpload: 'Click to upload screenshots',
        autoTitleHint: 'Auto title from description',
        defaultStatusHint: 'Default status: Pending',
        sortHint: 'Sorted by recent activity',
        previewBeforeSubmit: 'Preview before submit',
        pendingNewDisplayId: 'BUG-new · Pending',
        submitter: 'Submitter',
        ...
        submitSuccessHint: 'After submission, the new Bug is selected and opened in detail automatically.',
        contentRequiredHint: 'Please describe the problem before submitting. Failed screenshot uploads only affect that image and will not clear your text.',
        imageLimitReached: ({ max }: { max: number }) => `Up to ${max} screenshots can be attached.`,
        screenshots: 'Screenshots',
        submit: 'Submit Bug',
        accessCode: 'Share Password',
        accessCodePlaceholder: 'Enter share password',
        nickname: 'Nickname',
        nicknamePlaceholder: 'Enter your nickname',
        statusPending: 'Pending',
        statusInProgress: 'In Progress',
        statusVerify: 'Pending Verification',
        statusClosed: 'Closed',
        deleteHide: 'Delete and Hide',
        deleteHideConfirmTitle: 'Delete and hide?',
        deleteHideConfirmMessage: 'This Bug will be hidden from Happy and the shared board. Existing sessions will remain.',
        deletedOrHidden: 'Bug has been deleted or is no longer visible.',
        close: 'Close',
        changeStatus: 'Change Status',
        updatingStatus: 'Updating…',
        imageTooLarge: 'Each image must be 20MB or smaller.',
        returnToPending: 'Return to Pending',
        startRepairSession: 'Start Repair Session',
        openBugDetail: 'Open Bug Detail',
        editContent: 'Edit',
        ...
        status: 'Status',
        logout: 'Re-enter Password',
        refresh: 'Refresh',
        statusHistory: 'Status History',
        entryUrl: 'Entry URL',
        emptyForRandom: 'Leave empty to generate randomly',
        tapToCopyShownOnce: 'Tap to copy; shown only once',
        generateRandom: 'Generate Random',
        saveCustomCode: 'Save Custom Password',
        loadingGithub: 'Loading GitHub Issues…',
        loadingBugs: 'Loading Bugs…',
        loadingPending: 'Loading pending items…',
        noMatchingGithub: 'No matching GitHub Issues',
        noGithub: 'No pending GitHub Issues',
        noMatchingBugs: 'No matching Bugs',
        noMatchingPending: 'No matching pending items',
        searchAllPlaceholder: 'Search #1212 / BUG-1042 / title',
        searchGithubPlaceholder: 'Search #1212 / title / repo',
        searchBugPlaceholder: 'Search BUG-1042 / description / status',
        githubFilters: 'GitHub Filters',
        system: 'System',
        anonymousUser: 'Anonymous user',
        publicBoardSubtitle: 'Enter the shared password and nickname to submit, comment, and view status',
        enterBoard: 'Enter Bug Board',
        accessCodeRequired: 'Enter the shared password',
        nicknameRequired: 'Enter your nickname',
        shareCodeRotated: 'Share password updated. Old passwords and open pages expire immediately.',
        shareExpired: 'Share password expired. Please enter it again.',
        noBugs: 'No Bugs',
        noPendingItems: 'No pending items',
        filterOpen: 'Unclosed',
        filterHasComments: 'Has Comments',
        filterHasAttachments: 'Has Screenshots',
        currentFilter: 'Current filter',
        filterNote: 'Default shows unclosed Bugs (pending + in progress + pending verification), so closed items do not crowd the list.',
        items: 'items',
        recentActivity: 'recent activity',
        selectedInFilter: 'selected in current filter',
        detailPlaceholderTitle: 'Select a Bug',
        detailPlaceholderSubtitle: 'Choose a Bug on the left to view description, screenshots, comments, and status history.',
        statusFlow: 'Status Filter & Flow',
        currentStatus: 'Current',
        changeToThisStatus: 'Change to this',
    },
