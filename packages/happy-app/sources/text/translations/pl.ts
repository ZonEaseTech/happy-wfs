...
export const pl: TranslationStructure = {
    ...
    browser: {
        ...
        compressDownload: 'Skompresuj i pobierz',
        compressing: 'Pakowanie...',
        compressLargeWarning: ({ sizeMb }: { sizeMb: string }) => `Zaznaczenie ma ~${sizeMb} MB. Pobieranie może być wolne lub się nie powieść. Kontynuować?`,
