...
export const pl: TranslationStructure = {
    ...
    openclaw: {
        ...
        machineTypeHappy: 'Maszyna Happy AI',
        machineTypeHappyDescription: 'Połącz przez maszynę Happy AI na swoim komputerze',
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Happy AI to mobilny klient Claude Code, Codex i Gemini. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic ani OpenAI.',
        whatsNew: 'Co nowego',
    ...
    newSession: {
        ...
        branchMode: {
            ...
            existingBranch: 'Istniejąca gałąź',
        },
        repos: {
    ...
    session: {
        ...
        abortConfirmMessage: 'Czy na pewno chcesz przerwać bieżącą sesję?',
        abortConfirmAction: 'Przerwij',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: 'Udostępnić sesję?',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `Udostępnić tę sesję użytkownikom ${names}, aby mogli wysyłać wiadomości?`,
            mentionShareConfirmAction: 'Udostępnij i wyślij',
            mentionShareFailed: 'Nie udało się udostępnić sesji przed wysłaniem.',
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer Happy AI',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sesji Happy AI skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Happy AI',
        happySessionId: 'ID sesji Happy AI',
        ...
        happyHome: 'Katalog domowy Happy AI',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g @zonease/happy@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj Happy AI CLI',
            runIt: 'Uruchom je',
    ...
    files: {
        ...
        foundNearbyRepos: 'Znaleziono następujące repozytoria git w podkatalogach (dotknij, aby przełączyć)',
    ...
    fileViewer: {
        ...
        download: 'Pobierz',
        deleteFile: 'Usuń plik',
        deleteFileConfirm: ({ name }: { name: string }) => `Usunąć „${name}"? Tej operacji nie można cofnąć.`,
        deleteDir: 'Usuń folder',
        deleteDirConfirm: ({ name }: { name: string }) => `Usunąć folder „${name}" wraz z całą zawartością? Tej operacji nie można cofnąć.`,
    ...
    claudeConfig: {
        ...
        agentsMdSubtitle: 'Instrukcje użytkownika dla narzędzi obsługujących AGENTS.md (codex itp.)',
    ...
    settingsVoice: {
        ...
        happyVoiceDescription: 'Skonfiguruj własną bramę głosową Happy AI Voice.',
        gatewayUrl: 'URL bramy',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Happy AI. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `happy daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g @zonease/happy@latest`',
    ...
    codex: {
        ...
        permissions: {
            yesAllowAllTools: 'Tak, zezwól na wszystkie narzędzia podczas tej sesji',
    ...
    wizard: {
        ...
        showMoreProfiles: ({ count }: { count: number }) => `Pokaż więcej (${count})`,
