...
export const pt: TranslationStructure = {
    ...
    browser: {
        ...
        selectedCount: ({ count }: { count: number }) => `${count} selecionado(s)`,
        compressDownload: 'Compactar e baixar',
        compressing: 'Empacotando...',
        compressLargeWarning: ({ sizeMb }: { sizeMb: string }) => `A seleção ocupa ~${sizeMb} MB. O download pode ser lento ou falhar. Continuar?`,
        compressFailed: 'Falha na compactação',
