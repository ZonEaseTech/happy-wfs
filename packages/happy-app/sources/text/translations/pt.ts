...
export const pt: TranslationStructure = {
    ...
    session: {
        ...
        abortConfirmMessage: 'Tem certeza de que deseja abortar a sessão atual?',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: 'Compartilhar sessão?',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `Compartilhar esta sessão com ${names} para que possam enviar mensagens?`,
            mentionShareConfirmAction: 'Compartilhar e enviar',
            mentionShareFailed: 'Falha ao compartilhar a sessão antes de enviar.',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor execute npm install -g @zonease/happy@latest',
    ...
    fileViewer: {
        ...
        download: 'Baixar',
        deleteFile: 'Excluir arquivo',
        deleteFileConfirm: ({ name }: { name: string }) => `Excluir «${name}»? Esta ação é irreversível.`,
        deleteDir: 'Excluir pasta',
        deleteDirConfirm: ({ name }: { name: string }) => `Excluir a pasta «${name}» e todo o seu conteúdo? Esta ação é irreversível.`,
        renamePrompt: 'Novo nome',
        newFilePrompt: 'Nome do arquivo',
        newFolderPrompt: 'Nome da pasta',
        fileExists: 'Já existe um arquivo com esse nome.',
        dirExists: 'Já existe uma pasta com esse nome.',
        upload: 'Enviar',
        uploading: 'Enviando...',
        uploadFailed: 'Falha no envio',
        uploadOverwriteConfirm: ({ name }: { name: string }) => `"${name}" já existe. Substituir?`,
        diff: 'Diff',
        diffLoading: 'Carregando diff…',
        diffUnavailable: 'Diff indisponível (HEAD inacessível)',
    },
    ...
    claudeConfig: {
        ...
        agentsMdSubtitle: 'Instruções no nível do usuário para ferramentas compatíveis com AGENTS.md (codex, etc.)',
    ...
    settingsVoice: {
        ...
        providerDescription: 'Escolha qual serviço de voz usar. As alterações entram em vigor na próxima sessão de voz.',
        providerElevenLabsSubtitle: 'Serviço de voz IA ElevenLabs',
        providerHappyVoiceSubtitle: 'Serviço de voz IA profundamente otimizado',

        elevenLabsTitle: 'ElevenLabs',
        elevenLabsDescription: 'Configure seu agente ElevenLabs. Deixe vazio para usar o padrão.',
    ...
    codex: {
        ...
        permissions: {
            yesAllowAllTools: 'Sim, permitir todas as ferramentas durante esta sessão',
