...
export const ru: TranslationStructure = {
    ...
    openclaw: {
        ...
        machineTypeHappy: 'Happy AI машина',
        machineTypeHappyDescription: 'Подключение через Happy AI машину на вашем компьютере',
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'Happy AI — мобильное приложение для работы с Claude Code, Codex и Gemini. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic или OpenAI.',
        whatsNew: 'Что нового',
    ...
    server: {
        ...
        notValidHappyServer: 'Это не валидный сервер Happy AI',
    ...
    sessionInfo: {
        ...
        happySessionId: 'ID сессии Happy AI',
        ...
        happyHome: 'Домашний каталог Happy AI',
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g @zonease/happy@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Установите Happy AI CLI',
            runIt: 'Запустите его',
    ...
    session: {
        ...
        abortConfirmMessage: 'Вы уверены, что хотите прервать текущую сессию?',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: 'Поделиться сессией?',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `Поделиться этой сессией с ${names}, чтобы они могли отправлять сообщения?`,
            mentionShareConfirmAction: 'Поделиться и отправить',
            mentionShareFailed: 'Не удалось поделиться сессией перед отправкой.',
    ...
    fileViewer: {
        ...
        download: 'Скачать',
        deleteFile: 'Удалить файл',
        deleteFileConfirm: ({ name }: { name: string }) => `Удалить «${name}»? Это действие необратимо.`,
        deleteDir: 'Удалить папку',
        deleteDirConfirm: ({ name }: { name: string }) => `Удалить папку «${name}» со всем содержимым? Это действие необратимо.`,
    ...
    claudeConfig: {
        ...
        agentsMdSubtitle: 'Инструкции уровня пользователя для AGENTS.md-совместимых инструментов (codex и др.)',
    ...
    settingsVoice: {
        ...
        happyVoiceDescription: 'Настройте собственный голосовой шлюз Happy AI Voice.',
        gatewayUrl: 'URL шлюза',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Терминал запрашивает подключение к вашему аккаунту Happy AI. Это позволит терминалу безопасно отправлять и получать сообщения.',
    ...
    codex: {
        ...
        permissions: {
            yesAllowAllTools: 'Да, разрешить все инструменты в этой сессии',
