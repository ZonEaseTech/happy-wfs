...
export const ru: TranslationStructure = {
    ...
    browser: {
        ...
        select: 'Выбрать',
        selectAll: 'Все',
        invertSelection: 'Инверсия',
        selectedCount: ({ count }: { count: number }) => `Выбрано: ${count}`,
        compressDownload: 'Сжать и скачать',
        compressing: 'Упаковка...',
        compressLargeWarning: ({ sizeMb }: { sizeMb: string }) => `Выбор занимает ~${sizeMb} МБ. Загрузка может быть медленной или не удастся. Продолжить?`,
        compressFailed: 'Не удалось сжать',
