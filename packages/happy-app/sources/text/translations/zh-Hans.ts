...
export const zhHans: TranslationStructure = {
    ...
    devices: {
        describe: '用途说明',
        describeTitle: '设备用途',
        describeHint: '写清这台机器是干嘛用的,AI 在设备列表里会看到,便于挑对机器执行命令。',
        ...
        offline: '离线',
        emptyTitle: '还没有设备',
        emptyDescription: '生成纳管命令,在服务器或电脑上执行一次,设备就会出现在这里。',
        enrollTitle: '纳管命令',
        enrollHint: '复制到目标机器执行(15 分钟内有效,仅可使用一次):',
        needLogin: '需要先登录才能生成纳管命令',
    },
    ...
    settings: {
        ...
        devicesSubtitle: '纳管服务器与电脑,供 AI 直接执行任务',
        history: '历史记录',
