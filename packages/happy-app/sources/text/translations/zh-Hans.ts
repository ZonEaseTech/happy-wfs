...
export const zhHans: TranslationStructure = {
    ...
    portProxy: {
        emptyTitle: '没有端口代理',
        emptyDescription: '通过 Happy 服务器中转暴露本机 HTTP 服务',
        addProxy: '添加代理',
        editProxy: '编辑代理',
        listTitle: '端口代理',
        name: '名称',
        namePlaceholder: '本地 Web 应用',
        selectMachine: '选择机器',
        noMachines: '暂无可用机器',
        noMachinesDescription: '先连接一台 Happy 机器，再创建代理',
        localHost: '本地 Host',
        localPort: '本地端口',
        localPortHint: '当前版本仅支持本机回环 HTTP 目标。',
        options: '选项',
        enabled: '已启用',
        disabled: '已停用',
        enabledDescription: '允许已认证的中转请求访问这个本地服务',
        create: '创建代理',
        privateOnlyHint: '中转链接为私有链接，需要使用你的 Happy 账号认证。',
        deleteTitle: '删除代理',
        deleteMessage: ({ name }: { name: string }) => `删除“${name}”？`,
        loadFailed: '读取端口代理失败',
        updateFailed: '更新代理失败',
        deleteFailed: '删除代理失败',
        saveFailed: '保存代理失败',
        ...
        relayUrl: '中转链接',
        copyRelayUrl: '点击复制中转链接',
        machineLockedHint: '编辑时暂不支持切换机器，如需更换机器请新建代理。',
    },
    ...
    settings: {
        ...
        portProxySubtitle: '通过 Happy 服务器中转本机端口',
        history: '历史记录',
    ...
    settingsFeatures: {
        ...
        inputFeatures: '输入功能',
        inputFeaturesDescription: '分别管理 Web/桌面端和移动端的回车发送行为。',
        enterToSendWeb: 'Web/桌面端回车发送',
        enterToSendWebEnabled: 'Web/桌面端：按回车发送（Shift+回车换行）',
        enterToSendWebDisabled: 'Web/桌面端：回车换行',
        enterToSendMobile: '移动端回车发送',
        enterToSendMobileEnabled: '移动端：按回车发送',
        enterToSendMobileDisabled: '移动端：回车换行',
        commandPalette: '命令面板',
    ...
    settingsFeishu: {
        ...
        footer: '会话结束时，服务器会向您的飞书群机器人发送一条仅含元数据的消息。会话内容端到端加密，永不外发。',
        mentionWebhookSection: '协作 @ 通知 Webhook',
        mentionFooter: '协作备注里 @ 用户时，服务器会向这个 Webhook 发送一条消息。备注正文会外发，并最多保留 500 字。',
        mentionEnableTitle: '启用协作 @ 通知',
        mentionEnableSubtitle: '只有带 @ 的协作备注会使用这个 Webhook',
        mentionTestTitle: '发送协作 @ 测试消息',
        mentionTestSubtitle: '单独验证 @ 通知 Webhook 是否能投递',
        mentionTestSubtitleWithTime: ({ time }: { time: string }) => `最近 @ 测试：${time}`,
        mentionTestSuccessMessage: '请到飞书群里查看协作 @ 测试消息。',
        userIdLabel: '我的飞书用户 ID（可选）',
        userIdPlaceholder: 'ou_xxx 或企业员工 user_id',
        userIdHint: '填写后，协作 @ 通知会在飞书里真实 @ 到你（需在机器人所在群内）。ID 可在飞书管理后台查询。',
        urlLabel: 'Webhook 地址',
        secretLabel: '签名密钥（可选）',
        secretPlaceholder: '留空则保留现有密钥',
        secretHint: '当机器人启用了签名校验时必填。',
        enableTitle: '启用飞书通知',
        enableSubtitle: '总开关 — 关闭后通知静默但配置保留',
        saveTitle: '保存更改',
        saveDirty: '有未保存的更改',
        saveClean: '没有待保存的更改',
        testTitle: '发送测试消息',
        testSubtitle: '保存前验证 Webhook 是否能投递',
        testSubtitleWithTime: ({ time }: { time: string }) => `最近测试：${time}`,
        testSuccessTitle: '已发送测试',
        testSuccessMessage: '请到飞书群里查看测试消息。',
    ...
    session: {
        ...
        abortConfirmMessage: '确定要终止当前会话吗？',
        abortConfirmAction: '终止',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: '共享会话？',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `要先把此会话共享给 ${names}，允许他们发送消息吗？`,
            mentionShareConfirmAction: '共享并发送',
            mentionShareFailed: '发送前共享会话失败。',
            manageSharing: '管理共享',
            ...
            allowPublicChat: '允许聊天',
            allowPublicChatDescription: '允许拿到链接的人向此会话发送消息。',
            publicChatPlaceholder: '输入消息...',
            publicChatSendFailed: '发送消息失败',
    ...
    sessionInfo: {
        ...
        autoReviewGuardUncertain: '审查无法判断',
        autoReviewGuardSettings: '守护审查设置',
        autoReviewGuardRunNow: '立即审查',
        autoReviewGuardRunNowStarted: '已触发守护审查',
        autoReviewGuardRunNowFailed: '触发守护审查失败',
        autoReviewGuardEnabledLabel: '启用当前会话守护审查',
        autoReviewGuardEnabledHint: '监听完成声明，并自动审查代码完成度。',
        autoReviewGuardDelay: '触发延迟（秒）',
        autoReviewGuardTriggers: '触发词，每行一个',
        autoReviewGuardTriggersPlaceholder: '已完成\\n验证通过\\n请确认',
        autoReviewGuardSimplifyOnPass: '审查通过后发送 /simplify',
        autoReviewGuardSimplifyOnPassHint: '/simplify 只作为最终收尾，不再阻塞审查。',
        autoReviewGuardReviewPrompt: '审查提示词',
        autoReviewGuardFollowUpTemplate: '自动追问模板',
        autoReviewGuardTemplateHint: '可用变量：{{missing}}、{{summary}}、{{evidence}}',
        autoReviewGuardRestoreDefaults: '恢复默认',
        autoReviewGuardSaveDefault: '保存为默认',
        autoReviewGuardSaveSession: '保存当前会话',
        autoReviewGuardSavedSession: '已保存当前会话守护审查设置',
        autoReviewGuardSavedDefault: '已保存守护审查默认设置',
        ...
        updateCliInstructions: '请运行 npm install -g @zonease/happy@latest',
        ...
        mentions: {
            partialFailureTitle: '部分提及失败',
            partialFailureMessage: ({ names }: { names: string }) => `无法通知 ${names}`,
            mentionNotifyTitle: '有人提及了你',
            mentionNotifyMessage: ({ names }: { names: string }) => `${names} 在会话中提及了你`,
            mentionNotifyAction: '打开会话',
        },
    ...
    agentInput: {
        ...
        quickActions: {
            title: 'AI 快捷操作',
            customize: '自定义...',
            customizeTitle: '自定义 AI 快捷操作',
            customizePrompt: '编辑 JSON 数组。字段：label、description、prompt，可选 icon。用 {{projectPath}} 表示当前项目路径。保存空数组 [] 可恢复默认。',
            ...
            releaseGuard: {
                title: '发布验证',
                description: '发布前先跑完整验证',
                prompt: '请先运行 `happy release guard --package happy-cli --dry-run` 做发布前验证。除非我在 dry-run 通过后明确确认，否则不要运行 `--publish` 或 `--yes`。',
            },
            evidenceReport: {
                title: '证据报告',
                description: '记录截图或日志并生成报告',
                prompt: '请收集 UI/调试证据。如果我提供了图片或日志路径，运行 `happy evidence add <path> --title "<title>"`；然后运行 `happy evidence report` 并总结报告。',
            },
        },
        model: {
            title: '模型',
    ...
    fileViewer: {
        ...
        download: '下载',
        deleteFile: '删除文件',
        deleteFileConfirm: ({ name }: { name: string }) => `确认删除「${name}」？此操作不可恢复。`,
        deleteDir: '删除文件夹',
        deleteDirConfirm: ({ name }: { name: string }) => `确认删除文件夹「${name}」及其全部内容？此操作不可恢复。`,
        renamePrompt: '新名称',
        newFilePrompt: '文件名',
    ...
    claudeConfig: {
        ...
        agentsMdSubtitle: '用户级指令文件，被 codex 等 AGENTS.md 兼容工具识别',
        browse: '浏览 ~/.claude',
    ...
    mcpConfig: {
        ...
        machineFooter: ({ machine, status }: { machine: string; status: string }) => `将在 ${machine}（${status}）上编辑各 CLI 配置文件`,
        noMachine: '没有已连接的机器。',
        machineOffline: '机器离线。',
        noMachineFooter: '连接机器后即可编辑 MCP 配置。',
        browseGroup: '浏览配置目录',
        browseTarget: ({ target }: { target: string }) => `浏览 ${target} 配置`,
    ...
    terminal: {
        ...
        manageTerminals: '管理终端',
        terminalManager: '终端管理',
        noBackgroundTerminals: '没有后台终端。',
        closeTerminalWorkspace: '关闭这一组终端',
        terminalCount: ({ count }: { count: number }) => `${count} 个终端`,
        quickCommands: '快捷指令',
        quickCommandsAddTitle: '新增快捷指令',
        quickCommandsEditTitle: '编辑快捷指令',
        quickCommandsEditAction: '编辑',
        quickCommandsNamePrompt: '请输入这条指令的显示名称。',
        quickCommandsNamePlaceholder: '指令名称',
        quickCommandsCommandPrompt: '请输入要执行的终端命令。',
        quickCommandsEmpty: '还没有快捷指令。',
    ...
    machine: {
        ...
        offlineHelp: '• 确保您的计算机在线\n• 运行 `happy daemon status` 进行诊断\n• 您是否在运行最新的 CLI 版本？请使用 `npm install -g @zonease/happy@latest` 升级',
        daemon: '守护进程',
        status: '状态',
        stopDaemon: '停止守护进程',
    ...
    message: {
        ...
        collaborationBadge: '协作备注 · 不发送给 AI',
    },
    ...
    feed: {
        ...
        sessionMentionTitle: ({ name }: { name: string }) => `${name} 在会话中提及了你`,
        sessionMentionFallback: '有人在会话中提及了你',
    },
    ...
    wizard: {
        ...
        statusOffline: '离线',
        permDefault: '默认',
        permDefaultDesc: '请求权限',
        permAcceptEdits: '接受编辑',
        permAcceptEditsDesc: '自动批准编辑',
        permPlan: '规划',
        permPlanDesc: '执行前先规划',
        permBypass: '跳过权限',
        permBypassDesc: '跳过所有权限',
        permYolo: 'YOLO',
        permYoloDesc: '完全不确认',
        permReadOnly: '只读',
        permReadOnlyDesc: '只读模式',
        permSafeYolo: 'Safe YOLO',
        permSafeYoloDesc: '工作区写入需审批',
    ...
    bug: {
        ...
        content: '问题内容',
        createSubtitle: '只需要写一次问题；截图可以在同一区域粘贴、拖拽或上传。',
        createPlaceholderDetailed: '请描述你遇到的问题，例如：操作步骤、期望结果、实际结果。可以直接在这里 Ctrl/Cmd + V 粘贴截图。',
        noteStyleSubtitle: '像备忘录一样写：文字、截图、继续文字。标题会自动生成。',
        noteStylePlaceholder: '请描述你遇到的问题：\n操作步骤、期望结果、实际结果。\n\n光标在哪，粘贴截图就插到哪里。',
        noteStyleContinuePlaceholder: '继续输入文字，或直接粘贴下一张截图...',
        noteStyleFooterHint: '可粘贴、拖拽或点击添加图片；问题说明必填。',
        previewTitlePlaceholder: '等待填写问题说明',
        imageCounter: ({ count, max }: { count: number; max: number }) => `已添加 ${count}/${max} 张`,
        imageDropTitle: '截图区域和描述合在一起',
        imageDropHint: '支持粘贴、拖拽、点击上传；最多 10 张，每张 20MB。',
        pasteShortcut: 'Ctrl/Cmd + V',
        clickToUpload: '点击上传截图',
        autoTitleHint: '自动生成标题',
        defaultStatusHint: '默认待处理',
        sortHint: '按最近动态排序',
        previewBeforeSubmit: '提交前预览',
        pendingNewDisplayId: 'BUG-新建 · 待处理',
        submitter: '提交人',
        ...
        afterSubmit: '提交后',
        openDetail: '打开详情',
        submitSuccessHint: '提交成功后会自动选中新 Bug，并打开详情。',
        contentRequiredHint: '请先描述问题；截图上传失败只影响对应图片，不会清空文字。',
        imageLimitReached: ({ max }: { max: number }) => `最多只能添加 ${max} 张截图。`,
        screenshots: '截图',
        submit: '提交 Bug',
        accessCode: '共享密码',
        ...
        statusClosed: '已关闭',
        deleteHide: '删除不显示',
        deleteHideConfirmTitle: '删除不显示？',
        deleteHideConfirmMessage: '这个 Bug 会从 Happy 和共享入口列表隐藏，已开启的会话仍会保留。',
        deletedOrHidden: 'Bug 已删除或不可见。',
        close: '关闭',
        changeStatus: '改状态',
        updatingStatus: '修改中…',
        imageTooLarge: '每张图片不能超过 20MB。',
        returnToPending: '打回待处理',
        startRepairSession: '开启修复会话',
        openBugDetail: '打开 Bug 详情',
        editContent: '编辑',
        editingContent: '正在编辑内容',
        savingContent: '保存中…',
        comment: '评论',
        addComment: '补充评论',
        ...
        statusHistory: '状态历史',
        entryUrl: '入口地址',
        emptyForRandom: '留空随机生成',
        tapToCopyShownOnce: '点击复制；只显示这一次',
        generateRandom: '随机生成',
        saveCustomCode: '保存自定义密码',
        loadingGithub: '正在读取 GitHub Issues…',
        loadingBugs: '正在读取 Bug…',
        loadingPending: '正在读取待处理内容…',
        noMatchingGithub: '没有匹配条件的 GitHub Issues',
        noGithub: '没有待处理的 GitHub Issues',
        noMatchingBugs: '没有匹配条件的 Bug',
        noMatchingPending: '没有匹配条件的待处理内容',
        searchAllPlaceholder: '搜索 #1212 / BUG-1042 / 标题',
        searchGithubPlaceholder: '搜索 #1212 / 标题 / 仓库',
        searchBugPlaceholder: '搜索 BUG-1042 / 问题说明 / 状态',
        githubFilters: 'GitHub 过滤',
        system: '系统',
        anonymousUser: '匿名用户',
        publicBoardSubtitle: '输入共享密码和昵称后即可提交、评论和查看状态',
        enterBoard: '进入 Bug 列表',
        accessCodeRequired: '请输入共享密码',
        ...
        filterOpen: '未关闭',
        filterHasComments: '有评论',
        filterHasAttachments: '有截图',
        currentFilter: '当前筛选',
        filterNote: '默认显示“未关闭”（待处理 + 进行中 + 待验证），避免已关闭问题占满列表。',
        items: '条',
        recentActivity: '最近动态',
        selectedInFilter: '当前在筛选中',
        detailPlaceholderTitle: '请选择一个 Bug',
        detailPlaceholderSubtitle: '点击左侧 Bug 后，可查看问题说明、截图、评论和状态历史。',
        statusFlow: '状态筛选与流转',
        currentStatus: '当前',
        changeToThisStatus: '改为此状态',
    },
