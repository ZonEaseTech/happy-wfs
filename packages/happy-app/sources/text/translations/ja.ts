...
export const ja: TranslationStructure = {
    ...
    session: {
        ...
        abortConfirmMessage: '現在のセッションを中止してもよろしいですか？',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: 'セッションを共有しますか？',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `${names} がメッセージを送信できるように、このセッションを共有しますか？`,
            mentionShareConfirmAction: '共有して送信',
            mentionShareFailed: '送信前のセッション共有に失敗しました。',
            manageSharing: '共有を管理',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'npm install -g @zonease/happy@latest を実行してください',
    ...
    fileViewer: {
        ...
        download: 'ダウンロード',
        deleteFile: 'ファイルを削除',
        deleteFileConfirm: ({ name }: { name: string }) => `「${name}」を削除しますか？この操作は取り消せません。`,
        deleteDir: 'フォルダを削除',
        deleteDirConfirm: ({ name }: { name: string }) => `フォルダ「${name}」とその中身をすべて削除しますか？この操作は取り消せません。`,
        renamePrompt: '新しい名前',
        newFilePrompt: 'ファイル名',
    ...
    claudeConfig: {
        ...
        agentsMdSubtitle: 'AGENTS.md 対応ツール (codex など) のユーザーレベル指示',
    ...
    codex: {
        ...
        permissions: {
            yesAllowAllTools: 'はい、このセッション中のすべてのツールを許可',
    ...
    mcpManager: {
        title: ({ target }: { target: string }) => `${target} · MCP サーバー`,
        addTitle: 'MCP サーバーを追加',
        editTitle: 'MCP サーバーを編集',
        empty: 'MCP サーバーが設定されていません。',
        addRow: '+ 追加',
        deleteTitle: 'サーバーを削除',
        deleteMessage: ({ name }: { name: string }) => `「${name}」を削除しますか？`,
        saveFailed: '設定ファイルの保存に失敗しました。',
        parseError: 'この設定ファイルを解析できませんでした。',
        openRawFile: '元のファイルを開く',
        fieldName: '名前',
        fieldTransport: 'トランスポート',
        fieldCommand: 'コマンド',
        fieldArgs: '引数',
        fieldEnv: '環境変数',
        fieldUrl: 'URL',
        ...
        errNameDuplicate: '同じ名前のサーバーが既に存在します。',
        errCommandRequired: 'コマンドは必須です。',
        errUrlRequired: 'URL は必須です。',
    },
