...
export const ca: TranslationStructure = {
    ...
    openclaw: {
        ...
        machineTypeHappy: 'Màquina Happy AI',
        machineTypeHappyDescription: 'Connectar a través d\'una màquina Happy AI al teu ordinador',
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Happy AI és un client mòbil de Claude Code, Codex i Gemini. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic ni OpenAI.',
        whatsNew: 'Novetats',
    ...
    session: {
        ...
        abortConfirmMessage: 'Esteu segur que voleu avortar la sessió actual?',
        abortConfirmAction: 'Avorta',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: 'Voleu compartir la sessió?',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `Voleu compartir aquesta sessió amb ${names} perquè puguin enviar missatges?`,
            mentionShareConfirmAction: 'Comparteix i envia',
            mentionShareFailed: 'No s\'ha pogut compartir la sessió abans d\'enviar.',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor Happy AI vàlid',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de Happy AI copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Happy AI',
        happySessionId: 'ID de la sessió de Happy AI',
        ...
        happyHome: 'Directori de Happy AI',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g @zonease/happy@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Happy AI CLI',
            runIt: 'Executa\'l',
    ...
    fileViewer: {
        ...
        find: 'Cerca',
        replace: 'Substitueix',
        gotoLine: 'Vés a la línia',
        upOneLevel: 'Un nivell amunt',
        refreshTree: 'Actualitza l’arbre',
        newItem: 'Nou…',
        newFile: 'Fitxer nou',
        ...
        deleteFileConfirm: ({ name }: { name: string }) => `Voleu suprimir «${name}»? Aquesta acció és irreversible.`,
        deleteDir: 'Suprimeix la carpeta',
        deleteDirConfirm: ({ name }: { name: string }) => `Voleu suprimir la carpeta «${name}» i tot el seu contingut? Aquesta acció és irreversible.`,
        renamePrompt: 'Nom nou',
        newFilePrompt: 'Nom del fitxer',
        ...
        diff: 'Diff',
        diffLoading: 'Carregant diff…',
        diffUnavailable: 'Diff no disponible (HEAD inabastable)',
    },
    ...
    settingsVoice: {
        ...
        happyVoiceDescription: 'Configura la teva passarel·la de veu Happy AI Voice autoallotjada.',
        gatewayUrl: 'URL de la passarel·la',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Happy AI. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    codex: {
        ...
        permissions: {
            yesAllowAllTools: 'Sí, permet totes les eines durant aquesta sessió',
