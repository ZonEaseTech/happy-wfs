...
export const ca: TranslationStructure = {
    ...
    browser: {
        ...
        select: 'Selecciona',
        selectAll: 'Tot',
        invertSelection: 'Inverteix',
        selectedCount: ({ count }: { count: number }) => `${count} seleccionat(s)`,
        compressDownload: 'Comprimeix i descarrega',
        compressing: 'Empaquetant...',
        compressLargeWarning: ({ sizeMb }: { sizeMb: string }) => `La selecció ocupa ~${sizeMb} MB. La descàrrega pot ser lenta o fallar. Continuar?`,
        compressFailed: 'La compressió ha fallat',
