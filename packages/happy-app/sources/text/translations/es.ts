...
export const es: TranslationStructure = {
    ...
    openclaw: {
        ...
        machineTypeHappyDescription: 'Conectar a través de una máquina Happy AI en tu ordenador',
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Happy AI es un cliente móvil para Claude Code, Codex y Gemini. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic ni OpenAI.',
        whatsNew: 'Novedades',
    ...
    session: {
        ...
        abortConfirmMessage: '¿Está seguro de que desea abortar la sesión actual?',
        abortConfirmAction: 'Abortar',
        ...
        sharing: {
            ...
            mentionShareConfirmTitle: '¿Compartir sesión?',
            mentionShareConfirmMessage: ({ names }: { names: string }) => `¿Compartir esta sesión con ${names} para que puedan enviar mensajes?`,
            mentionShareConfirmAction: 'Compartir y enviar',
            mentionShareFailed: 'No se pudo compartir la sesión antes de enviar.',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor Happy AI válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de Happy AI copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Happy AI',
        happySessionId: 'ID de sesión de Happy AI',
        ...
        happyHome: 'Directorio de Happy AI',
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g @zonease/happy@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el Happy AI CLI',
            runIt: 'Ejecútelo',
    ...
    files: {
        ...
        foundNearbyRepos: 'Se encontraron estos repositorios git en subdirectorios (toca para cambiar)',
    ...
    fileViewer: {
        ...
        download: 'Descargar',
        deleteFile: 'Eliminar archivo',
        deleteFileConfirm: ({ name }: { name: string }) => `¿Eliminar «${name}»? Esta acción es irreversible.`,
        deleteDir: 'Eliminar carpeta',
        deleteDirConfirm: ({ name }: { name: string }) => `¿Eliminar la carpeta «${name}» y todo su contenido? Esta acción es irreversible.`,
    ...
    claudeConfig: {
        ...
        agentsMdSubtitle: 'Instrucciones a nivel de usuario para herramientas compatibles con AGENTS.md (codex, etc.)',
    ...
    injectedMemories: {
        ...
        manageAll: 'Gestionar todas las memorias',
    },
    ...
    settingsVoice: {
        ...
        providerElevenLabsSubtitle: 'Servicio de voz IA ElevenLabs',
        providerHappyVoiceSubtitle: 'Servicio de voz IA profundamente optimizado',
        ...
        happyVoiceDescription: 'Configura tu pasarela de voz Happy AI Voice autoalojada.',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Happy AI. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    codex: {
        ...
        permissions: {
            yesAllowAllTools: 'Sí, permitir todas las herramientas durante esta sesión',
    ...
    wizard: {
        ...
        showMoreProfiles: ({ count }: { count: number }) => `Mostrar más (${count})`,
