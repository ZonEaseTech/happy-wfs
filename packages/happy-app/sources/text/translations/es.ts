...
export const es: TranslationStructure = {
    ...
    browser: {
        ...
        selectedCount: ({ count }: { count: number }) => `${count} seleccionado(s)`,
        compressDownload: 'Comprimir y descargar',
        compressing: 'Empaquetando...',
        compressLargeWarning: ({ sizeMb }: { sizeMb: string }) => `La selección ocupa ~${sizeMb} MB. La descarga puede ser lenta o fallar. ¿Continuar?`,
        compressFailed: 'Falló la compresión',
