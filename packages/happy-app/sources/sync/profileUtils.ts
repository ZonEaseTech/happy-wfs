...
export Z_AI_HAIKU_MODEL="GLM-4.5-Air"`,
        ...
        case 'openai':
            return {
                ...
                description: 'OpenAI GPT-5.5 Codex API for code generation and completion',
                environmentVariables: [
                    {
...
export OPENAI_MODEL="gpt-5.5-codex-high"
export OPENAI_SMALL_FAST_MODEL="gpt-5.5-codex-low"`,
            };
        case 'azure-openai':
            return {
        ...
        case 'openai':
            return {
                ...
                environmentVariables: [
                    ...
                    { name: 'OPENAI_MODEL', value: 'gpt-5.5-codex-high' },
                    { name: 'OPENAI_API_TIMEOUT_MS', value: '600000' },
                    { name: 'OPENAI_SMALL_FAST_MODEL', value: 'gpt-5.5-codex-low' },
        ...
        case 'azure-openai':
            return {
                ...
                environmentVariables: [
                    ...
                    { name: 'AZURE_OPENAI_DEPLOYMENT_NAME', value: 'gpt-5.5-codex' },
                    { name: 'OPENAI_API_TIMEOUT_MS', value: '600000' },
                    { name: 'API_TIMEOUT_MS', value: '600000' },
                ],
                compatibility: { claude: false, codex: true, gemini: false },
