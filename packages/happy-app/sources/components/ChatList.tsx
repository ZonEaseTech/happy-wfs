...
import { buildRailEntries, ChatMessageRail, RAIL_SUPPORTED, RAIL_WIDTH } from '@/components/ChatMessageRail';
    ...
    return (
        <View style={{ flex: 1 }}>
            <FlatList
                ...
                contentContainerStyle={railGutter > 0 ? { paddingLeft: railGutter } : undefined}
