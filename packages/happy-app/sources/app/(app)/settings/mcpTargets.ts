...
export const CONFIG_TARGETS: ConfigTarget[] = [
    { key: 'claude', title: 'Claude', subtitle: '~/.mcp.json · mcpServers', fileName: '.mcp.json', dirName: '', language: 'JSON', validateJson: true, codecTarget: 'claude', icon: 'sparkles-outline', color: '#5856D6' },
