---
title: "Encryption"
description: "How Happy AI protects your code and conversations with end-to-end encryption."
---
...
- **Private key** — Stored locally at `~/.happy-ai/access.key` (never leaves your device)
...
<Warning>
**Back up `~/.happy-ai/access.key`.** This file is your encryption private key. If you lose it, you permanently lose access to your encrypted session history. There is no recovery mechanism — this is by design.
</Warning>
