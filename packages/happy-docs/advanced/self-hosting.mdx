...
You can host your own Happy server instead of using the hosted service at `api.happy.weifashi.cn`. This gives you complete control over your data and infrastructure.
