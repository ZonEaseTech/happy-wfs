...
| **Google AI** | Gemini | Google | gemini-3-pro-preview |
...
Profiles are synced between the app and CLI automatically. The daemon reads the active profile from `~/.happy-ai/settings.json` when spawning new sessions.
