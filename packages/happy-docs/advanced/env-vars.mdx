...
description: "Complete reference for all Happy AI environment variables."
---
...
|----------|---------|-------------|
| `HAPPY_SERVER_URL` | `https://api.happy.weifashi.cn` | Happy server API endpoint |
| `HAPPY_WEBAPP_URL` | `https://app.happy.weifashi.cn` | Happy web app URL |
| `HAPPY_HOME_DIR` | `~/.happy-ai` | Local data directory |
