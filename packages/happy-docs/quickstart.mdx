...
- A phone with the Happy AI app installed ([iOS (TestFlight)](https://testflight.apple.com/join/XyjvbhXe) / [Android (APK)](https://github.com/hitosea/happy-ai/releases/latest))
