---
title: "环境变量"
description: "Happy AI 所有环境变量的完整参考。"
---
...
| 变量 | 默认值 | 描述 |
|----------|---------|-------------|
| `HAPPY_SERVER_URL` | `https://api.happy.weifashi.cn` | Happy 服务器 API 端点 |
| `HAPPY_WEBAPP_URL` | `https://app.happy.weifashi.cn` | Happy Web 应用 URL |
| `HAPPY_HOME_DIR` | `~/.happy-ai` | 本地数据目录 |
