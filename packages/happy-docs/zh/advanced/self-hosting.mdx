---
title: "自托管"
description: "部署你自己的 Happy AI 服务器，完全掌控你的数据。"
---

你可以托管自己的 Happy 服务器，而不是使用 `api-happy.zonease.org` 上的托管服务。这让你完全掌控自己的数据和基础设施。

Happy 支持两种模式：
- **托管（默认）** — 客户端开箱即用地使用 `https://api-happy.zonease.org`
