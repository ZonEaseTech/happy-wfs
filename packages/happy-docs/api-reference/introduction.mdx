---
title: "API Reference"
description: "The Happy AI REST API for building integrations."
---

The Happy AI API is a REST API served by the Happy AI server. All endpoints use JSON for request and response bodies.

## Base URL

**Hosted service:**
```
https://api.happy.weifashi.cn
```
